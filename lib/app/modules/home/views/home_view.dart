...
import 'github_repo_info_page.dart'; // Pastikan ini diimpor
...
class _HomeViewState extends State<HomeView> {
  ...
  static final List<Widget> _pages = <Widget>[
    ...
    AllGamesPage(),
    ProfilePage(),
    GitHubRepoInfoPage(), // Tambahkan halaman GitHub di sini jika diperlukan
  ];
            ...
            Row(
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    Get.toNamed(
                        Routes.GITHUB_REPO_INFO); // Navigasi ke halaman GitHub
                  },
                ),
                GestureDetector(
                  onTap: () {
